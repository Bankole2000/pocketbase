...
import (
	...
	"github.com/bankole2000/pocketbase/tools/filesystem/blob"
	"github.com/bankole2000/pocketbase/tools/filesystem/internal/fileblob"
	"github.com/bankole2000/pocketbase/tools/filesystem/internal/s3blob"
	"github.com/bankole2000/pocketbase/tools/filesystem/internal/s3blob/s3"
...
var manualExtensionContentTypes = map[string]string{
	...
	".js":  "text/javascript", // (see https://github.com/bankole2000/pocketbase/issues/6597)
	".mjs": "text/javascript",
}
